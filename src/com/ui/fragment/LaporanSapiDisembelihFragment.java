...
import com.ui.adapter.LaporanSapiDisembelihAdapter;
import com.ui.common.DatabaseHelper;
import com.ui.common.General;
import com.ui.elivestock.R;

public class LaporanSapiDisembelihFragment extends Fragment {
	...
	public LaporanSapiDisembelihFragment(Context mContext) {
...
//		setHasOptionsMenu(true);
	...
	private void setLayout(LayoutInflater inflater, View resultView) {
		...
		button.setText("Laporan Sapi Disembelih");
		
		LaporanSapiDisembelihAdapter adapter = new LaporanSapiDisembelihAdapter(
				mContext, R.layout.item_list_with_icon_sapi_penyembelihan,
				db.getLaporanPenyembelihan());
