...
public class Cari_KejadianBeranakModelSync {

	@SerializedName("kode_kejadian_beranak")
	String kode_kejadian_beranak;
	...
	public String getKode_kejadian_beranak() {
		return kode_kejadian_beranak;
	}

	public void setKode_kejadian_beranak(String kode_kejadian_beranak) {
