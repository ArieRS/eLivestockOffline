...
public class DeleteDataSapiBetinaSync extends AsyncTask<String, Void, String> {
	FragmentActivity mFragmentActivity;
	Context mContext;
	EditDataSapiModelSync mEditDataSapiModelSync;
	ProgressDialog mDialog;
	
	public DeleteDataSapiBetinaSync(FragmentActivity activity, Context context,
...
//			json.put("status_kepemilikan", mEditDataSapiModelSync.getStatus_kepemilikan());
			...
			json.put("transaksi", mContext.getResources().getString(
					R.string.delete_data_sapi_betina));
			return HttpRequestHelper.doPost(
					mContext.getResources().getString(
							R.string.url_delete_sapi_betina), json);
