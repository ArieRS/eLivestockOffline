...
public class DeleteKejadianBeranakSync extends AsyncTask<String, Void, String> {
	FragmentActivity mFragmentActivity;
	Context mContext;
	EditKejadianBeranakModelSync mEditKejadianBeranakModelSync;
	private ProgressDialog mDialog;

	public DeleteKejadianBeranakSync(FragmentActivity activity, Context context,
		...
		try {
			...
			json.put(
					...
					mContext.getResources().getString(
							R.string.delete_kejadian_beranak));

			return HttpRequestHelper.doPost(
					mContext.getResources().getString(
							R.string.url_delete_kejadian_beranak), json);
	...
	protected void onPostExecute(String result) {
		...
		try {
			...
			//{"kode_kejadian_beranak":11,"message":"gagal insert data","status":0,"guid":"9bfb6b05-065e-4463-b29e-8019bd477d82"}
