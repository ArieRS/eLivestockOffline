...
public class DeleteMasterProvinsiSync extends AsyncTask<String, Void, String> {
	Context mContext;
	FragmentActivity mFragmentActivity;
	EditMasterProvinsiModelSync mEditMasterProvinsiModelSync;
	private ProgressDialog mDialog;
	
	public DeleteMasterProvinsiSync(FragmentActivity activity, Context context,
...
//			json.put("nama_provinsi",mEditMasterProvinsiModelSync.getNama_provinsi());
			...
			json.put(
					...
					mContext.getResources().getString(
							R.string.delete_master_provinsi));

			return HttpRequestHelper.doPost(
					mContext.getResources().getString(
							R.string.url_delete_master_provinsi), json);
