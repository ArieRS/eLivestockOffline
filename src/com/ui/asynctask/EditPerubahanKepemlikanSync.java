...
public class EditPerubahanKepemlikanSync extends AsyncTask<String, Void, String> {
	FragmentActivity mFragmentActivity;
	Context mContext;
	EditPerubahanKepemilikanModelSync mEditPerubahanKepemilikanModelSync;
	private ProgressDialog mDialog;

	public EditPerubahanKepemlikanSync(FragmentActivity fragmentActivity,
			Context context,
		...
		try {
			...
			json.put(
					...
					mContext.getResources().getString(
							R.string.edit_perubahan_kepemilikan));

			Log.d("json", json.toString());

			return HttpRequestHelper.doPost(
					mContext.getResources().getString(
							R.string.url_edit_perubahan_kepemilikan), json);
