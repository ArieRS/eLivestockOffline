...
public class EditMasterLokasiSync extends AsyncTask<String, Void, String> {
	FragmentActivity mFragmentActivity;
	Context mContext;
	EditMasterLokasiModelSync mEditMasterLokasiModelSync;
	private ProgressDialog mDialog;
	
	public EditMasterLokasiSync(FragmentActivity activity, Context context, EditMasterLokasiModelSync editMasterLokasiModelSync){
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			json.put("transaksi", mContext.getResources().getString(R.string.edit_master_lokasi));
			
			return HttpRequestHelper.doPost(
					mContext.getResources().getString(
							R.string.url_edit_master_lokasi), json);
