...
public class DeleteKejadianIbSync extends AsyncTask<String, Void, String> {
	FragmentActivity mFragmentActivity;
	Context mContext;
	EditKejadianIBModelSync mEditKejadianIBModelSync;
	private ProgressDialog mDialog;

	public DeleteKejadianIbSync(FragmentActivity fragmentActivity,
...
//			json.put("id_petugas", mEditKejadianIBModelSync.getId_petugas());
			...
			json.put("transaksi", mContext.getResources().getString(R.string.delete_kejadian_ib));
			
			return HttpRequestHelper.doPost(mContext.getResources().getString(R.string.url_delete_kejadian_ib), json);
